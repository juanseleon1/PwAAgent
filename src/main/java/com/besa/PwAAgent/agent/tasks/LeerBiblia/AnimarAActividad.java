...
public class AnimarAActividad extends SRTask {
    ...
    public boolean checkFinish(Believes beliefs) {
        ...
        ReportBESA.debug("checkFinishSolicitarActividad: " + answer + "super: "+super.checkFinish(beliefs));
        ReportBESA.debug("has finished: "+ (super.checkFinish(beliefs) && !answer.isEmpty() && (answer.equals("oracion") || answer.equals("versiculo"))));
        return super.checkFinish(beliefs) && !answer.isEmpty() && (answer.equals("oracion") || answer.equals("versiculo"));
    }
